<x-guest-layout>
    <x-auth-card>
        ...
        <div class="mb-4 text-sm text-gray-600">
            {{ __('Es necesario verificar tu cuenta antes de continuar, revisa tu correo y has clic en el enlace de confirmacion.') }}
        </div>

        @if (session('status') == 'verification-link-sent')
            <div class="mb-4 font-medium text-sm text-green-600">
                {{ __('Hemos en viado el correo con el enlace de confirmación.') }}
            </div>
        @endif
